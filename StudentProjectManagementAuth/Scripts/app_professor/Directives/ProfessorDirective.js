angular.module('angular-img-cropper', ['ui.bootstrap'])

.directive("imageCropper",  ['$document','$window', function($document,$window)
{
  return {
        scope: {
            image: "=",
...
angular.module('angular-img-cropper').directive("imgCropperFileread", ['$timeout', '$modal',
                    ...
                    reader.onload = function (loadEvent) {
                        $timeout(function () {
                            ...
                            var modalInstance = $modal.open({
                                templateUrl: '/Areas/Professor/Templates/ChangeAvatarModal.html',
